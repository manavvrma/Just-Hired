          ...
          {user?.user?.accountType === undefined && info?._id === user?._id && (
            <div className="flex items-center justify-center py-5 md:py-0 gap-4">
              <CustomButton
                ...
                iconRight={<FiEdit3 />}
                containerStyles={`py-1.5 px-3 md:px-5 focus:outline-none bg-red-600 hover:bg-red-700 text-white rounded text-sm md:text-base border border-red-600`}
              />
              ...
              <Link to="/upload-job">
                <CustomButton
                  title="Upload Job"
                  iconRight={<FiUpload />}
                  containerStyles={`text-red-600 py-1.5 px-3 md:px-5 focus:outline-none rounded text-sm md:text-base border border-red-600`}
                />
              </Link>
            </div>
          )}
