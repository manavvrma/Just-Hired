  ...
  return (
    <div className="container mx-auto flex flex-col md:flex-row gap-8 2xl:gap-14 bg-white  px-5  ">
      <div className="w-full h-fit md:w-2/3 2xl:2/4 bg-white px-5 py-10 md:px-10 shadow-md">
        <div>
          <p className="text-black-800 font-semibold text-2xl">Job Post</p>
          ...
          >
            ...
            <div className="mt-2">
              {isLoading ? (
                ...
                <CustomButton
                  type="submit"
                  containerStyles="inline-flex justify-center rounded-md border border-transparent bg-red-600 px-8 py-2 text-sm font-medium text-white hover:bg-red-200 hover:text-red-800 focus:outline-none "
                  title="Submit"
                />
              )}
            </div>
