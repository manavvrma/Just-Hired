                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea
                        className="ounded border border-gray-400 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 text-base px-4 py-2 resize-none"
                        rows={4}
                        cols={6}
                        {...register("about", {
                          required:
    ...
    <div className="container mx-auto flex items-center justify-center py-10">
      <div className="w-full md:w-2/3 2xl:w-2/4 bg-white shadow-lg p-10 pb-20 rounded-lg">
        <div className="flex flex-col items-center justify-center mb-4">
          ...
          <h5 className="text-red-700 text-base font-bold">
        ...
        <div className="w-full py-10">
          <div className="w-full flex flex-col-reverse md:flex-row gap-8 py-6">
            ...
            <div className="w-full md:w-1/3 h-44">
              ...
              />
              <button
                className="w-full md:w-64 bg-red-600 text-white mt-4 py-2 rounded"
