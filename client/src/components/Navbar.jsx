...
const Navbar = () => {
  ...
  return (
    <>
      <div className="relative sticky top-0 bg-white z-50">
        <nav className="container mx-auto flex items-center justify-between p-5">
          <div>
            <Link
              to="/"
              className="text-black font-playfair text-40 flex items-center gap-1"
            >
              <span>
          ...
          <ul className="hidden lg:flex gap-10 justify-center text-base">
            <li>
